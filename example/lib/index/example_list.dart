...
import 'package:im_sdk_plugin_example/entity/api_data_entity.dart';
import 'package:im_sdk_plugin_example/entity/api_item_entity.dart';
import 'package:im_sdk_plugin_example/i18n/i18n_utils.dart';
import 'package:im_sdk_plugin_example/im/api_detail_layout.dart';
      ...
      children: [
        Expanded(
          child: Container(
            ...
            child: ListView(
              children: Config.apiData.map((e) => Managers(ApiData.fromJson(e))).toList(),
            ),
          ),
        ),
      ],
      ...
      child: ExpandablePanel(
        header: Container(
          ...
          child: Row(
            children: [
              Expanded(
                child: Text(data.managerName, style: const TextStyle(fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ),
        collapsed: Container(),
        expanded: Column(children: data.apis.map((e) => Apis(e)).toList()),
...
class Apis extends StatelessWidget {
  ...
  toApiDetailPage(context) {
    Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (BuildContext context) => ApiDetailLayout(api)));
  }
