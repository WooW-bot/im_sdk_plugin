...
class DeleteFromFriendListState extends State<DeleteFromFriendList> {
  ...
  FriendTypeEnum deleteType = FriendTypeEnum.IM_FRIEND_TYPE_BOTH;

  deleteFromFriendList() async {
    ImValueCallback<List<ImFriendOperationResult>> res =
        await ImSDKPlugin.imManager.getFriendshipManager().deleteFromFriendList(
          userIDList: users,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                      ...
                      showAdaptiveActionSheet(
                        ...
                        actions: <BottomSheetAction>[
                          BottomSheetAction(
                            ...
                            onPressed: (context) {
                              setState(() {
                                deleteType = FriendTypeEnum.IM_FRIEND_TYPE_BOTH;
                              });
                          ...
                          BottomSheetAction(
                            ...
                            onPressed: (context) {
                              setState(() {
                                deleteType = FriendTypeEnum.IM_FRIEND_TYPE_SINGLE;
                              });
                              Navigator.pop(context);
                            },
                          ),
                ...
                Container(margin: EdgeInsets.only(left: 12), child: Text("已选：$deleteType")),
              ],
            ),
          ),
          new Row(
            children: [
              Expanded(
                child: ElevatedButton(onPressed: deleteFromFriendList, child: Text(imt("删除好友"))),
              ),
            ],
          ),
          SDKResponse(resData),
