...
import 'package:im_sdk_plugin/enum/message_elem_type.dart';
...
import 'package:im_sdk_plugin/enum/history_msg_get_type_enum.dart';
...
class GetHistoryMessageListState extends State<GetHistoryMessageList> {
  ...
  HistoryMsgGetTypeEnum type = HistoryMsgGetTypeEnum.IM_GET_LOCAL_OLDER_MSG;

  getHistoryMessageList() async {
    ImValueCallback<ImMessageListResult> res = await ImSDKPlugin.imManager.getMessageManager()
        .getHistoryMessageListV2(
          ...
          lastMsgID: lastMsgID,
          getType: type,
          messageTypeList: [MessageElemType.IM_ELEM_TYPE_CUSTOM],
        );
    setState(() {
      resData = res.toJson();
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
                ...
                onPressed: () {
                  showAdaptiveActionSheet(
                    ...
                    actions: <BottomSheetAction>[
                      BottomSheetAction(
                        title: const Text('IM_GET_CLOUD_NEWER_MSG'),
                        onPressed: (context) {
                          setState(() {
                            type = HistoryMsgGetTypeEnum.IM_GET_CLOUD_NEWER_MSG;
                            lastMsgID = null;
                          });
                      ...
                      BottomSheetAction(
                        title: const Text('IM_GET_CLOUD_OLDER_MSG'),
                        onPressed: (context) {
                          setState(() {
                            type = HistoryMsgGetTypeEnum.IM_GET_CLOUD_OLDER_MSG;
                            lastMsgID = null;
                          });
                          Navigator.pop(context);
                        },
                      ...
                      BottomSheetAction(
                        title: const Text('IM_GET_LOCAL_OLDER_MSG'),
                        onPressed: (context) {
                          setState(() {
                            type = HistoryMsgGetTypeEnum.IM_GET_LOCAL_OLDER_MSG;
                            lastMsgID = null;
                          });
                          Navigator.pop(context);
                        },
                      ...
                      BottomSheetAction(
                        title: const Text('IM_GET_LOCAL_NEWER_MSG'),
                        onPressed: (context) {
                          setState(() {
                            type = HistoryMsgGetTypeEnum.IM_GET_LOCAL_NEWER_MSG;
                            lastMsgID = null;
                          });
                          Navigator.pop(context);
                        },
              ...
              Container(margin: const EdgeInsets.only(left: 12), child: Text("已选：$type")),
            ],
          ),
        ),
        Row(
