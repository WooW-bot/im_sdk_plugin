...
import 'package:im_sdk_plugin/enum/group_add_opt_type.dart';
...
import 'package:im_sdk_plugin_example/utils/customerField/CustomerField.dart';
...
class SetGroupInfoState extends State<SetGroupInfo> {
  ...
  int? addOpt = GroupAddOptType.IM_GROUP_ADD_AUTH;

  setGroupInfo() async {
    ImCallback res = await ImSDKPlugin.imManager.getGroupManager().setGroupInfo(
      info: ImGroupInfo.fromJson({
        "groupID": group.first,
        "groupName": groupName,
        "groupType": groupType,
      ...
      child: Column(
        children: [
                ...
                child: Form(
                  child: Column(
                    children: <Widget>[
                                  ...
                                  showAdaptiveActionSheet(
                                    ...
                                    actions: <BottomSheetAction>[
                                      BottomSheetAction(
                                        ...
                                        onPressed: (context) {
                                          setState(() {
                                            addOpt = GroupAddOptType.IM_GROUP_ADD_ANY;
                                          });
                                          Navigator.pop(context);
                                        },
                                      ),
                                      BottomSheetAction(
                                        ...
                                        onPressed: (context) {
                                          setState(() {
                                            addOpt = GroupAddOptType.IM_GROUP_ADD_AUTH;
                                          });
                                          Navigator.pop(context);
                                        },
                                      ),
                                      BottomSheetAction(
                                        ...
                                        onPressed: (context) {
                                          setState(() {
                                            addOpt = GroupAddOptType.IM_GROUP_ADD_FORBID;
                                          });
                                          Navigator.pop(context);
                                        },
                                      ),
                      ...
                      CustomerField(onSetField: onSetField, maxSetCount: 10),
                    ],
                  ),
                ),
              ),
          ...
          new Row(
            children: [
              Expanded(
                child: ElevatedButton(onPressed: setGroupInfo, child: Text(imt("设置群信息"))),
              ),
            ],
          ),
          SDKResponse(resData),
