...
class GetGroupMemberListState extends State<GetGroupMemberList> {
  ...
  getGroupMemberList() async {
    ImValueCallback<ImGroupMemberInfoResult> res =
                    ...
                    onPressed: () {
                      showAdaptiveActionSheet(
                        ...
                        actions: <BottomSheetAction>[
                          BottomSheetAction(
                            title:
                                const Text('IM_GROUP_MEMBER_FILTER_ADMIN'),
                            onPressed: (context) {
                              setState(() {
                                filter = GroupMemberFilterTypeEnum
                                    .IM_GROUP_MEMBER_FILTER_ADMIN;
                              });
                              Navigator.pop(context);
                            },
                          ),
                          BottomSheetAction(
                            title: const Text('IM_GROUP_MEMBER_FILTER_ALL'),
                            onPressed: (context) {
                              setState(() {
                                filter = GroupMemberFilterTypeEnum
                                    .IM_GROUP_MEMBER_FILTER_ALL;
                              });
                              Navigator.pop(context);
                            },
                          ),
                          BottomSheetAction(
                            title:
                                const Text('IM_GROUP_MEMBER_FILTER_COMMON'),
                            onPressed: (context) {
                              setState(() {
                                filter = GroupMemberFilterTypeEnum
                                    .IM_GROUP_MEMBER_FILTER_COMMON;
                              });
                              Navigator.pop(context);
                            },
                          ),
                          BottomSheetAction(
                            title:
                                const Text('IM_GROUP_MEMBER_FILTER_OWNER'),
                            onPressed: (context) {
                              setState(() {
                                filter = GroupMemberFilterTypeEnum
                                    .IM_GROUP_MEMBER_FILTER_OWNER;
                              });
                              Navigator.pop(context);
                            },
                          ),
