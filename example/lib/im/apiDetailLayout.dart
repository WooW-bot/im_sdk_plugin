...
class ApiDetailLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('${pageData.apiNameCN} ${pageData.apiName}')),
      body: Container(
      ...
      children: [
        Expanded(
          child: Card(
            ...
            child: SizedBox(
              height: 300,
              child: CodeArea(codeFile: pageData.codeFile),
            ),
          ),
        ),
      ],
...
class CodeArea extends StatefulWidget {
  ...
  const CodeArea({Key? key, required this.codeFile}) : super(key: key);
