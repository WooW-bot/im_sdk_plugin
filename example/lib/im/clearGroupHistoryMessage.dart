...
class ClearGroupHistoryMessageState extends State<ClearGroupHistoryMessage> {
  ...
  getGroupsInfo() async {
    var res = await ImSDKPlugin.imManager.getMessageManager().clearGroupHistoryMessage(
      ...
      child: Column(
        children: [
          ...
          new Row(
            children: [
              Expanded(
                child: ElevatedButton(onPressed: getGroupsInfo, child: Text(imt("获取群组信息"))),
              ),
            ],
          ),
          SDKResponse(resData),
