...
class AddFriendState extends State<AddFriend> {
  ...
  FriendTypeEnum addType = FriendTypeEnum.IM_FRIEND_TYPE_BOTH;
  ...
  addFriend() async {
    ImValueCallback<ImFriendOperationResult> res = await ImSDKPlugin.imManager
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                      ...
                      showAdaptiveActionSheet(
                        ...
                        actions: <BottomSheetAction>[
                          BottomSheetAction(
                            ...
                            onPressed: (context) {
                              setState(() {
                                addType = FriendTypeEnum.IM_FRIEND_TYPE_BOTH;
                              });
                          ...
                          BottomSheetAction(
                            ...
                            onPressed: (context) {
                              setState(() {
                                addType = FriendTypeEnum.IM_FRIEND_TYPE_SINGLE;
                              });
                              Navigator.pop(context);
                            },
                          ),
                ...
                Container(margin: EdgeInsets.only(left: 12), child: Text("已选：$addType")),
              ],
            ),
          ),
          Row(
            children: [
              Expanded(
                child: ElevatedButton(onPressed: addFriend, child: Text(imt("添加好友"))),
              ),
            ],
          ),
          SDKResponse(resData),
