...
import 'conversationSelector.dart';
import 'messageSelector.dart';
...
class DeleteMessageFromLocalStorageState extends State<DeleteMessageFromLocalStorage> {
  ...
  deleteMessageFromLocalStorage() async {
    ImCallback res = await ImSDKPlugin.imManager.getMessageManager().deleteMessageFromLocalStorage(
      msgID: msgIDs.first,
    );
    setState(() {
      resData = res.toJson();
